...
- 下游实例系统、镜像系统、镜像仓库存在承载上限，需要多维度限流。
...
- 下游实例系统、镜像系统、镜像仓库能够提供必要的幂等或结果查询能力。
